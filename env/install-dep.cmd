...
call mvn -N  install:install-file -Dfile=%~dp0/libs/cds-starter-jpa-2.1.jar -DpomFile=%~dp0/libs/cds-starter-jpa-2.1.pom
call mvn -N  install:install-file -Dfile=%~dp0/libs/cds-starter-jsonview-2.2-SNAPSHOT.jar -DpomFile=%~dp0/libs/cds-starter-jsonview-2.2-SNAPSHOT.pom
